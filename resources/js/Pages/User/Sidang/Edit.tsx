...
export default function SidangEdit({ sidang, mahasiswa, dosen, pic, ruangan, jam, tahunAkademikOptions }: Props) {
    const { data, setData, put, errors, processing } = useForm({
        mahasiswa_id: String(sidang.mahasiswa_id),
        judul_skripsi: sidang.judul_skripsi,
        penguji1_id: String(sidang.penguji1_id),
        penguji2_id: String(sidang.penguji2_id),
        pimpinan_sidang_id: String(sidang.pimpinan_sidang_id),
        tanggal_ujian: sidang.tanggal_ujian,
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        put(route('sidang.update', sidang.id));
    };
