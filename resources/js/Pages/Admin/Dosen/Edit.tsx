...
export default function Edit({ dosen }: PageProps<Props>) {
                ...
                <form onSubmit={submit} className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            id="inisial"
                            value={data.inisial}
                            onChange={(e) => setData('inisial', e.target.value)}
                        />
                        {errors.inisial && <p className="text-sm text-destructive">{errors.inisial}</p>}
                    </div>
